...
public class HomeGeminiWrapperTest {
  ...
  //            + "Given this location and weather data, provide an answer in Json format with a
  // list of recommended fruits, vegetables and flowers that can be planted at this time, with each
  // value having:\n";
